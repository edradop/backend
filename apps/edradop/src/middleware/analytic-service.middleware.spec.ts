...
import { AnalyticServiceMiddleware } from './analytic-service.middleware';

describe('AnalyticServiceMiddleware', () => {
  ...
  it('should be defined', () => {
    expect(new AnalyticServiceMiddleware(httpEnvironmentService)).toBeDefined();
  });
});
